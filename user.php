...
<nav class="navbar navbar-inverse">
  ...
  <div class="wrapper">
    <form class="form-horizontal" action="user.php" method="post"  >
      ...
      <div class="col-sm-10">
		 ...
		 <div class="form-group">
	       <label class="control-label col-sm-2" for="select">Organization:</label>
       <div class="col-sm-10">
	        <input type="text" class="form-control" name="org"  required> 			
    </div>
	     </div>
		  <div class="form-group">
	       <label class="control-label col-sm-2" for="select">Contact-no:</label>
       <div class="col-sm-10">
	        <input type="number_format" class="form-control" name="cnt"  required> 			
    </div>
	     </div>
		  <div class="form-group">
	       <label class="control-label col-sm-2" for="select">Email:</label>
       <div class="col-sm-10">
      ...
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-primary" name="save" >Create</button>
		 <a href="viewcustomer.php" class="btn btn-default">Show list</a>
      </div>
    </div>
 ...
 <center> <p>© MaerskLine-2019</p></center>
  ...
  if (isset($_POST['save'])) {
		...
		mysqli_query($db, "INSERT INTO customer (Name, Organization,Contactno,Email) VALUES ('$name', '$org','$cnt','$email')"); 
