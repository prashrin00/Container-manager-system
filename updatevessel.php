            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2>Update Vessel</h2>
                        <a href="Createvessel.php" class="btn btn-success pull-left">Add New </a>
                    </div>
                    <?php
                    // Include config file
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['Capacity'] . "</td>";
                                            ...
                                            echo "<a href='deletevessel.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'>|Delete</a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
